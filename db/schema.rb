...
ActiveRecord::Schema.define(version: 20181103202229) do
  ...
  create_table "ciudads", force: :cascade do |t|
    ...
    t.bigint "pai_id"
    t.index ["pai_id"], name: "index_ciudads_on_pai_id"
  end
  ...
  create_table "publicacions", force: :cascade do |t|
    ...
    t.bigint "ciudad_id"
    t.bigint "user_id"
    t.index ["ciudad_id"], name: "index_publicacions_on_ciudad_id"
  ...
  add_foreign_key "publicacions", "ciudads"
