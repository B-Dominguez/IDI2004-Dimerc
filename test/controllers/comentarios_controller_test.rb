...
class ComentariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post comentarios_url, params: { comentario: { autor: @comentario.autor, contenido: @comentario.contenido, fecha: @comentario.fecha, id_comentario: @comentario.id_comentario, pertenece: @comentario.pertenece, ptje_rep: @comentario.ptje_rep } }
    end
  ...
  test "should update comentario" do
    patch comentario_url(@comentario), params: { comentario: { autor: @comentario.autor, contenido: @comentario.contenido, fecha: @comentario.fecha, id_comentario: @comentario.id_comentario, pertenece: @comentario.pertenece, ptje_rep: @comentario.ptje_rep } }
