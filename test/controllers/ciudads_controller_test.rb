...
class CiudadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ciudad" do
    assert_difference('Ciudad.count') do
      post ciudads_url, params: { ciudad: { cid: @ciudad.cid, descripcion: @ciudad.descripcion, nombre: @ciudad.nombre, pais: @ciudad.pais, ubicacion: @ciudad.ubicacion } }
    end
  ...
  test "should update ciudad" do
    patch ciudad_url(@ciudad), params: { ciudad: { cid: @ciudad.cid, descripcion: @ciudad.descripcion, nombre: @ciudad.nombre, pais: @ciudad.pais, ubicacion: @ciudad.ubicacion } }
