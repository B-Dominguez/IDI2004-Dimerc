...
class PaisControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pai" do
    assert_difference('Pai.count') do
      post pais_url, params: { pai: { descripcion: @pai.descripcion, nombre: @pai.nombre, pid: @pai.pid, suscriptores: @pai.suscriptores, ubicacion: @pai.ubicacion } }
    end
  ...
  test "should update pai" do
    patch pai_url(@pai), params: { pai: { descripcion: @pai.descripcion, nombre: @pai.nombre, pid: @pai.pid, suscriptores: @pai.suscriptores, ubicacion: @pai.ubicacion } }
