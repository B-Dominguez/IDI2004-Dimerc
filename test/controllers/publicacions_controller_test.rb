...
class PublicacionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create publicacion" do
    assert_difference('Publicacion.count') do
      post publicacions_url, params: { publicacion: { autor: @publicacion.autor, ciudad: @publicacion.ciudad, contenido: @publicacion.contenido, fecha: @publicacion.fecha, id_pub: @publicacion.id_pub, ptje_rep: @publicacion.ptje_rep, tipo: @publicacion.tipo, titulo: @publicacion.titulo } }
    end
  ...
  test "should update publicacion" do
    patch publicacion_url(@publicacion), params: { publicacion: { autor: @publicacion.autor, ciudad: @publicacion.ciudad, contenido: @publicacion.contenido, fecha: @publicacion.fecha, id_pub: @publicacion.id_pub, ptje_rep: @publicacion.ptje_rep, tipo: @publicacion.tipo, titulo: @publicacion.titulo } }
